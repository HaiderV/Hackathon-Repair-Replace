  ...
  const contactItems: ContactItem[] = [
    {
      ...
      label: "Email",
      value: "haidervadgamwal2@gmail.com",
  ...
  return (
    <PageLayout>
      <main>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-0">
              {[
                ...
                >
                  ...
                  {i < arr.length - 1 && (
                    <div
                      className="my-2 md:my-0 md:mx-2.5 self-center flex items-center justify-center"
                      style={{ color: "#6C79C0", flexShrink: 0 }}
                    >
                      <IconArrow size={18} />
                    </div>
                  )}
        ...
        {/* Contact (now alternating with natural page background) */}
